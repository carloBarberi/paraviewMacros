...
# Properties modified on slice1.SliceType
slice1.SliceType.Origin = [firstSlice/1000, 1.25, 1.25]
...
resultLUTColorBar.Orientation = 'Vertical'
...
#######################################################################################
# Set the camera perpendicular to X
...
renderView1.ResetCamera(-2.0, -2.0, -2.5, 0.0, -1.2974924511911043e-18, 2.5, True)
...
text1.Text = 'X = '+str(firstSlice)+'mm'
...
# save screenshot
SaveScreenshot(current_directory + '/../0_Figures/CpTx_slice/X_0.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
...
for xx in xx_slices:
    ...
    # Properties modified on slice1.SliceType
    slice1.SliceType.Origin = [xx/1000, -1.25, 1.25]
    ...
    # save screenshot
    SaveScreenshot(current_directory + '/../0_Figures/CpTx_slice/X_'+str(ii)+'.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
    OverrideColorPalette='WhiteBackground')
