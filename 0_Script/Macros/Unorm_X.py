...
# save screenshot
SaveScreenshot(current_directory + '/../0_Figures/Unorm_X_slices/X_0.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
...
for xx in xx_slices:
    ...
    # save screenshot
    SaveScreenshot(current_directory + '/../0_Figures/Unorm_X_slices/X_'+str(ii)+'.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
    OverrideColorPalette='WhiteBackground')
