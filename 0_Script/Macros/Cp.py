...
Fields = ['UMean', 'pMean', 'UNearMean']
# Formula used to calculate CpY
Formula = 'pMean / (0.5*40^2)'
...
if sLIC:
    ...
    # set scalar coloring
    ColorBy(calculator1Display, ('POINTS', 'UNearMean', 'Magnitude'))
    ...
    # get color transfer function/color map for 'UNearMeanMean'
    UNearMeanLUT = GetColorTransferFunction('UNearMean')

    # get opacity transfer function/opacity map for 'UNearMean'
    UNearMeanPWF = GetOpacityTransferFunction('UNearMean')

    # get 2D transfer function for 'UNearMean'
    UNearMeanTF2D = GetTransferFunction2D('UNearMean')

    # set scalar coloring
    ColorBy(calculator1Display, ('POINTS', 'Result'))

    # Hide the scalar bar for this color map if no visible data is colored by it.
    HideScalarBarIfNotNeeded(UNearMeanLUT, renderView1)
    ...
    calculator1Display.SelectInputVectors = ['POINTS', 'UNearMean']
...
resultLUTColorBar.Title = 'Cp mean                        '
...
# save screenshot
SaveScreenshot(current_directory + '/../0_Figures/Cp/01_Top.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
...
# save screenshot
SaveScreenshot(current_directory + '/../0_Figures/Cp/01_Bottom.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
    OverrideColorPalette='WhiteBackground')
...
# save screenshot
SaveScreenshot(current_directory + '/../0_Figures/Cp/01_Left.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
    OverrideColorPalette='WhiteBackground')
...
# save screenshot
SaveScreenshot(current_directory + '/../0_Figures/Cp/01_Right.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
    OverrideColorPalette='WhiteBackground')
...
# save screenshot
SaveScreenshot(current_directory + '/../0_Figures/Cp/01_Front.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
    OverrideColorPalette='WhiteBackground')
...
# save screenshot
SaveScreenshot(current_directory + '/../0_Figures/Cp/01_Rear.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
    OverrideColorPalette='WhiteBackground')
...
if sLIC:
    ...
    # set scalar coloring
    ColorBy(transform1Display, ('POINTS', 'UNearMean', 'Magnitude'))
    ...
    # get color transfer function/color map for 'UNearMean'
    UNearMeanLUT = GetColorTransferFunction('UNearMean')
    ...
    # Properties modified on calculator1Display
    transform1Display.SelectInputVectors = ['POINTS', 'UNearMean']
...
# save screenshot
SaveScreenshot(current_directory + '/../0_Figures/Cp/02_3D_1.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
    OverrideColorPalette='WhiteBackground')
...
# save screenshot
SaveScreenshot(current_directory + '/../0_Figures/Cp/02_3D_2.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
    OverrideColorPalette='WhiteBackground')
...
# save screenshot
SaveScreenshot(current_directory + '/../0_Figures/Cp/02_3D_3.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
    OverrideColorPalette='WhiteBackground')
...
# save screenshot
SaveScreenshot(current_directory + '/../0_Figures/Cp/02_3D_4.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
    OverrideColorPalette='WhiteBackground')
