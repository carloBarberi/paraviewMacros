...
# save screenshot
SaveScreenshot(current_directory + '/../0_Figures/Unorm_Y_slices/Y_'+str(firstSlice)+'.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
...
for yy in yy_slices:
    ...
    # save screenshot
    SaveScreenshot(current_directory + '/../0_Figures/Unorm_Y_slices/Y_'+str(yy)+'.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
    OverrideColorPalette='WhiteBackground')
