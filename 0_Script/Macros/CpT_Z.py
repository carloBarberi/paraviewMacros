...
pTF2D = GetTransferFunction2D('pMean')
...
# save screenshot
SaveScreenshot(current_directory + '/../0_Figures/CpTz_slice/Z_'+str(firstSlice)+'.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
...
for zz in zz_slices:
    ...
    # save screenshot
    SaveScreenshot(current_directory + '/../0_Figures/CpTz_slice/Z_'+str(zz)+'.jpeg', layout1, ImageResolution=[imageSize[0], imageSize[1]],
    OverrideColorPalette='WhiteBackground')
